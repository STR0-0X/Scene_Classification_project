...
def main():
    ...
    class_names = np.load(os.path.join(HIST_ROOT, "class_names.npy"))
    ...
    plot_confusion(
        ...
        os.path.join(RESULTS_ROOT, f"confusion_nn_k{K}.png")
    )
    ...
    plot_confusion(
        ...
        os.path.join(RESULTS_ROOT, f"confusion_svm_k{K}.png")
